...
class QgenGenerationPanesBaseSchema(CustomModel):
	...
	total_questions_count: int | None = Field(default=None)
...
class QgenGenerationPanesInsert(CustomModelInsert):
	...
	# fill_in_the_blanks_count: nullable, has default value
	# long_answer_count: nullable, has default value
	# mcq_count: nullable, has default value
	# msq_count: nullable, has default value
	# school_class_id: nullable
	# short_answer_count: nullable, has default value
	# subject_id: nullable
	# total_marks_count: nullable, has default value
	# total_questions_count: nullable, has default value
	# total_time_count: nullable, has default value
	# true_false_count: nullable, has default value
	# updated_at: nullable
