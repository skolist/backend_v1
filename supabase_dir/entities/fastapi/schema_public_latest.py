...
class GenQuestionsBaseSchema(CustomModel):
    ...
    position_in_section: int | None = Field(
        default=None,
...
class QgenDraftInstructionsUsersMapsBaseSchema(CustomModel):
    """QgenDraftInstructionsUsersMaps Base Schema."""
...
class QgenDraftInstructionsUsersMapsInsert(CustomModelInsert):
    """QgenDraftInstructionsUsersMaps Insert Schema."""
...
class QgenDraftInstructionsUsersMapsUpdate(CustomModelUpdate):
    """QgenDraftInstructionsUsersMaps Update Schema."""
...
class QgenDraftInstructionsUsersMaps(QgenDraftInstructionsUsersMapsBaseSchema):
    """QgenDraftInstructionsUsersMaps Schema for Pydantic.

    Inherits from QgenDraftInstructionsUsersMapsBaseSchema. Add any customization here.
    """
...
class Users(UsersBaseSchema):
    ...
    qgen_draft_instructions_users_maps: QgenDraftInstructionsUsersMaps | None = Field(
        default=None
    )
