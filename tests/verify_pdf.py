...
async def run_test():
    ...
    async with async_playwright() as p:
        ...
        html_paper = generate_paper_html(DUMMY_DRAFT, DUMMY_SECTIONS, DUMMY_QUESTIONS, DUMMY_INSTRUCTIONS, None, "paper", DUMMY_IMAGES)
        ...
        html_answer = generate_paper_html(DUMMY_DRAFT, DUMMY_SECTIONS, DUMMY_QUESTIONS, DUMMY_INSTRUCTIONS, None, "answer", DUMMY_IMAGES)
        page = await browser.new_page()
    ...
    print(f"Success! PDFs generated:")
