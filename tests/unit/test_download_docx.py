...
MOCK_QUESTIONS = [{"id": "q-1", "qgen_draft_section_id": "sec-1", "question_text": "Q1 $x^2$", "marks": 5, "is_in_draft": True}]
...
def test_download_docx_page_break(test_app):
    ...
    qs = [
        {"id": "q-1", "qgen_draft_section_id": "sec-1", "question_text": "Q1", "marks": 5, "is_page_break_below": True},
...
def test_download_docx_rollback_on_math_failure(test_app):
    ...
    qs = [{"id": "q-1", "qgen_draft_section_id": "sec-1", "question_text": f"Math: {latex_text}", "marks": 5}]
